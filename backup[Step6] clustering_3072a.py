...
# x_train_0 = x_train_0.reshape(840,1024)
# print(x_train_0)
y0=np.ones([840])*0
...
# x_train_1 = x_train_1.reshape(840,3072)
y1=np.ones([840])*1
...
# x_train_2 = x_train_2.reshape(840,3072)
y2=np.ones([840])*2
...
# x_train_3 = x_train_3.reshape(840,3072)
y3=np.ones([840])*3
...
# x_train_4 = x_train_4.reshape(840,3072)
y4=np.ones([840])*4
...
# x_train_5 = x_train_5.reshape(840,3072)
y5=np.ones([840])*5
...
# x_train_6 = x_train_6.reshape(840,3072)
y6=np.ones([840])*6
...
# x_train_7 = x_train_7.reshape(840,3072)
y7=np.ones([840])*7
...
# plt.savefig('./fig/cluster_dcae02.png')
plt.show()