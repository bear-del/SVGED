...
root_model = './model/dcae-C0'+label_out
...
for fault in faults:
    ...
    path_out = './model/dcae-C0'+label_out+'/'+fault+'_train'+label_out+'.pkl'
    path_1_out = './model/dcae-C0'+label_out+'/' + fault + '_test'+label_out+'.pkl'
    train_encoded = []
    test_encoded = []
